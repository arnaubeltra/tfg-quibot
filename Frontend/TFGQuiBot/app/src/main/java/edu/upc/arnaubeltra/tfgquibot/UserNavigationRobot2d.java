...
// Class that handles Navigation Drawer of the Robot 2D account.
public class UserNavigationRobot2d extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edu.upc.arnaubeltra.tfgquibot.databinding.ActivityUserNavigationRobot2dBinding binding = ActivityUserNavigationRobot2dBinding.inflate(getLayoutInflater());
    ...
    // Method to provide context of the UserNavigationRobot2d class (used in other classes).
    public static Context getContext() {
        return instance.getApplicationContext();
    }

    // Method to provide instance of the UserNavigationRobot2d class (used in other classes).
    ...
    // Definition of the Robot2D options menu. Inflating items to be added to the menu.
    @Override
